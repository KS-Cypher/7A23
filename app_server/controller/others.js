...
module.exports.signin = function(req, res){
    ...
    content: 'Loc8r is the application you will build throughout this book.  showing a list of places and details about each place, and allows visitors to log in and leave reviews.'
  });
  };
  /* GET 'register' page */
